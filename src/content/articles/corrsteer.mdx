...
Given a dataset of prompts, we generate responses and capture SAE activations at each layer. For each feature *z_i*, we compute its Pearson correlation with task outcomes *y*:
