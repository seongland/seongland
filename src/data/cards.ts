...
export const publications: CardData[] = [
  {
    ...
    image: '/image/optimismbench.webp',
  ...
  },
  {
    ...
    image: '/image/asg.webp',
    tags: ['Agent', 'LLM Safety'],
    links: [{ label: 'Article', url: '/article/asg' }],
  },
  {
  ...
  {
    title: 'FaithfulSAE: Towards Capturing Faithful Features with Sparse Autoencoders without External Datasets Dependency',
