...
export const LoadingIcon = (props: { className?: string }) => {
  ...
  return (
    <div display="block" className="animate-spin" w="10" h="10">
      <svg className={className} {...rest} viewBox="0 0 24 24">
        <defs>
        ...
        <g id="Page-1" stroke="none" strokeWidth="1" fill="none">
          <g transform="translate(-236.000000, -286.000000)">
            <g transform="translate(238.000000, 286.000000)">
              <circle id="Oval-1" stroke="url(#linearGradient-1)" strokeWidth="4" cx="10" cy="12" r="10" />
